...
This is a **CLI automation pipeline**, not web application. There is no user interface rendered in browser. Interaction happens via:
...
- Purpose: Visual proof that simulation rendered correctly
