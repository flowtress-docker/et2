...
main() {
  ...
  echo "Gallery:  http://127.0.0.1:${INDEX_PORT}/gallery.html  ← all 6 diagrams (use this)"
  echo "Index:    http://127.0.0.1:${INDEX_PORT}/"
  echo ""
  echo "OpenFlowKit Home (${APP_URL}/#/home) stays empty — et2 diagrams are not saved flows."
