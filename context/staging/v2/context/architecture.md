...
- **File system**: All variant projects, build outputs, artifacts, and registry live on disk.
...
2. variant is never simulated unless its firmware compiled successfully.
