# Kimi Code — Building Context

Read the following files in order before implementing
or making any architectural decision for staging/v2:
...
3. `context/ui-context.md` — artifact conventions,
   screenshot/log formats, and terminal output style
4. `context/code-standards.md` — implementation rules
   and conventions for Node.js, Arduino, JSON, YAML
